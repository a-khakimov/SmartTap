...
namespace odb
{
  ...
  const char access::object_traits_impl< ::player, id_pgsql >::
  persist_statement_name[] = "persist_player";

  const char access::object_traits_impl< ::player, id_pgsql >::
  find_statement_name[] = "find_player";

  const char access::object_traits_impl< ::player, id_pgsql >::
  update_statement_name[] = "update_player";

  const char access::object_traits_impl< ::player, id_pgsql >::
  erase_statement_name[] = "erase_player";

  const char access::object_traits_impl< ::player, id_pgsql >::
  query_statement_name[] = "query_player";

  const char access::object_traits_impl< ::player, id_pgsql >::
  erase_query_statement_name[] = "erase_query_player";
  ...
  struct access::object_traits_impl< ::player, id_pgsql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::player, id_pgsql >::id_type
  access::object_traits_impl< ::player, id_pgsql >::
  ...
  bool access::object_traits_impl< ::player, id_pgsql >::
  grow (image_type& i,
        bool* t)
  {
    ...
    if (t[3UL])
    {
      i.platform_value.capacity (i.platform_size);
      grew = true;
    }
  ...
  void access::object_traits_impl< ::player, id_pgsql >::
  bind (pgsql::bind* b,
        image_type& i,
        pgsql::statement_kind sk)
  {
    ...
    //
    b[n].type = pgsql::bind::text;
    b[n].buffer = i.platform_value.data ();
    b[n].capacity = i.platform_value.capacity ();
    b[n].size = &i.platform_size;
        ...
        pgsql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.platform_value.capacity ());
      pgsql::value_traits<
          ::std::string,
          pgsql::id_string >::set_image (
        i.platform_value,
      ...
      i.platform_size = size;
      grew = grew || (cap != i.platform_value.capacity ());
    }
  ...
  const char access::object_traits_impl< ::player, id_pgsql >::erase_statement[] =
  "DELETE FROM \"player\" "
  "WHERE \"id\"=$1";
  ...
  const char access::object_traits_impl< ::player, id_pgsql >::erase_query_statement[] =
  "DELETE FROM \"player\"";

  const char access::object_traits_impl< ::player, id_pgsql >::table_name[] =
  "\"player\"";
  ...
  access::object_traits_impl< ::player, id_pgsql >::pointer_type
  access::object_traits_impl< ::player, id_pgsql >::
  ...
  result< access::object_traits_impl< ::player, id_pgsql >::object_type >
  access::object_traits_impl< ::player, id_pgsql >::
  ...
  unsigned long long access::object_traits_impl< ::player, id_pgsql >::
